...
<head>
  ...
  <title>Starter Page - College Bootstrap Template</title>
...
<body class="starter-page-page">
  ...
  <header id="header-wrap" class="header d-flex align-items-center sticky-top"style="background-color: white;">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="../ksdc2/indexdemo.html" class="logo d-flex align-items-center me-auto">
        ...
        <ul>
         <pre>                            </pre>
          ...
          <li class="dropdown"><a href="#"><span>Events</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="events.html#Hackathon">Hackathon</a></li>
              <li><a href="events.html#Ideathon">Ideathon</a></li>
              <li><a href="events.html#Sponcership">Sponsorship</a></li>
              <li><a href="events.html#Collaboration">Collaboration</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown"><a href="#"><span>Publications</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="research.html#Articles">Articles</a></li>
              <li><a href="research.html#Journals">Journals</a></li>
              <li><a href="research.html#ResearchOpportunity">Research Opportunity</a></li>
            </ul>
          </li>
