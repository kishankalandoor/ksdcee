                ...
                <form>
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select" id="student-type">
                      ...
                      <option value="student">Under graduate Student</option>
                      <option value="parent">Post Graduate Student</option>
                      <option value="teacher">Professor</option>
                      <option value="teacher">IT Professional</option>
                      <option value="teacher">Free Lancer </option>
