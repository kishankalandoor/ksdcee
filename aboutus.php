...
<body class="index-page">
         ...
         <pre>                            </pre>
          ...
          <li class="dropdown"><a href="#"><span>About</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="kakunje-software.php">Kakunje Software</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown"><a href="#"><span>Events</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="ideathon.php">Ideathon</a></li>
          ...
          <li class="dropdown"><a href="#"><span>Publications</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="Research_Opportunity.php">Research Opportunity</a></li>
            </ul>
          </li>
  ...
  <a href="https://kakunjesoftware.com//#joinushere" class="glowing-join-button btn-getstarted">Join Us</a>
          ...
          <div class="col-lg-7" data-aos="fade-left" data-aos-delay="300">
            <div class="content-wrapper">
              ...
              <div class="cta-section" data-aos="fade-up" data-aos-delay="600">
                <a href="student-activities.php" class="btn-primary">Discover More</a>
                <a href="virtual-tour.php" class="btn-link">
