  ...
  <main class="main">
    ...
    <section id="campus-facilities" class="campus-facilities section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
       ...
       <center> <h2>Career @ Kakunje Software</h2></center>
                ...
                <div class="highlight-card">
                  ...
                  <div class="card-image">
                    ...
                    <div class="image-overlay">
                      <span class="category-tag">Software Developer</span>
                    </div>
                  </div>
                  <div class="card-body">
                    <h4>Software Developer</h4>
                    <p>Designs and builds software applications and systems for end users or clients.</p>
              ...
              <div class="swiper-slide">
                <div class="highlight-card">
                  ...
                  <div class="card-image">
                    ...
                    <div class="image-overlay">
                      <span class="category-tag">Embedded Systems Engineer</span>
                    </div>
                  </div>
                  <div class="card-body">
                    <h4>Embedded Systems Engineer</h4>
                    <p>Develops and integrates software with hardware for real-time embedded devices.</p>
                    <div class="card-stats">
                      <div class="stat">
                        <i class="bi bi-cpu"></i>
                        <span>Hardware Design Engineer</span>
                      </div>
                      <div class="stat">
              ...
              <div class="swiper-slide">
                <div class="highlight-card">
                  ...
                  <div class="card-image">
                    ...
                    <div class="image-overlay">
                      <span class="category-tag">Hardware Design Engineer</span>
                    </div>
                  </div>
                  <div class="card-body">
                    <h4>Hardware Design Engineer</h4>
                    <p>Creates schematics and layouts for electronic circuit boards and hardware components.</p>
                    <div class="card-stats">
                      <div class="stat">
              ...
              <div class="swiper-slide">
                <div class="highlight-card">
                  ...
                  <div class="card-image">
                    ...
                    <div class="image-overlay">
                      <span class="category-tag">RTL Design Engineer (VLSI)</span>
                    </div>
                  </div>
                  <div class="card-body">
                    <h4>RTL Design Engineer (VLSI)</h4>
                    <p>Writes Register Transfer Level (RTL) code to design digital logic circuits on chips.</p>
                    <div class="card-stats">
                      <div class="stat">
